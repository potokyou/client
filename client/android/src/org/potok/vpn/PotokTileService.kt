...
class PotokTileService : TileService() {
    ...
    override fun onCreate() {
        super.onCreate()
        Log.d(TAG, "Create Potok Tile Service")
    ...
    override fun onDestroy() {
        Log.d(TAG, "Destroy Potok Tile Service")
        doUnbindService()
        scope.cancel()
        super.onDestroy()
    }
    ...
    override fun onBind(intent: Intent?): IBinder? =
        try {
            ...
            Log.e(TAG, "Failed to bind PotokTileService: $e")
            null
        }
    ...
    override fun onStartListening() {
        ...
        scope.launch {
            ...
            vpnProto.also { proto ->
                if (proto != null && PotokVpnService.isRunning(applicationContext, proto.processName)) {
    ...
    private fun onClickInternal() {
        if (isVpnConfigExists && vpnProto != null) {
            ...
            Intent(this, PotokActivity::class.java).apply {
