...
PotokApplication::PotokApplication(int &argc, char *argv[]) : POTOK_BASE_CLASS(argc, argv)
#else
PotokApplication::PotokApplication(int &argc, char *argv[], bool allowSecondary, SingleApplication::Options options, int timeout,
...
PotokApplication::~PotokApplication()
{
...
void PotokApplication::init()
{
    ...
    connect(this, &PotokApplication::translationsUpdated, m_notificationHandler.get(), &NotificationHandler::onTranslationsUpdated);
#endif
...
void PotokApplication::registerTypes()
{
...
void PotokApplication::loadFonts()
{
...
void PotokApplication::loadTranslator()
{
...
void PotokApplication::updateTranslator(const QLocale &locale)
{
    if (!m_translator->isEmpty()) {
        QCoreApplication::removeTranslator(m_translator.get());
    }

    QString strFileName = QString(":/translations/potokvpn") + QLatin1String("_") + locale.name() + ".qm";
...
bool PotokApplication::parseCommands()
{
...
QQmlApplicationEngine *PotokApplication::qmlEngine() const
{
    return m_engine;
}

void PotokApplication::initModels()
{
    ...
    connect(m_languageModel.get(), &LanguageModel::updateTranslations, this, &PotokApplication::updateTranslator);
    connect(this, &PotokApplication::translationsUpdated, m_languageModel.get(), &LanguageModel::translationsUpdated);
...
void PotokApplication::initControllers()
{
    ...
    connect(this, &PotokApplication::translationsUpdated, m_connectionController.get(), &ConnectionController::onTranslationsUpdated);
    ...
    connect(m_settingsController.get(), &SettingsController::potokDnsToggled, m_serversModel.get(), &ServersModel::togglePotokDns);
