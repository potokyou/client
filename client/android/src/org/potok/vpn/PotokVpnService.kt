...
import org.potok.vpn.protocol.LoadLibraryException
import org.potok.vpn.protocol.ProtocolState.CONNECTED
import org.potok.vpn.protocol.ProtocolState.CONNECTING
import org.potok.vpn.protocol.ProtocolState.DISCONNECTED
import org.potok.vpn.protocol.ProtocolState.DISCONNECTING
import org.potok.vpn.protocol.ProtocolState.RECONNECTING
import org.potok.vpn.protocol.ProtocolState.UNKNOWN
import org.potok.vpn.protocol.VpnException
import org.potok.vpn.protocol.VpnStartException
import org.potok.vpn.protocol.putStatus
import org.potok.vpn.util.Log
import org.potok.vpn.util.Prefs
import org.potok.vpn.util.net.NetworkState
import org.potok.vpn.util.net.TrafficStats
import org.json.JSONException
import org.json.JSONObject

private const val TAG = "PotokVpnService"

const val ACTION_DISCONNECT = "org.potok.vpn.action.disconnect"
const val ACTION_CONNECT = "org.potok.vpn.action.connect"
...
open class PotokVpnService : VpnService() {
    ...
    override fun onCreate() {
        super.onCreate()
        Log.d(TAG, "Create Potok VPN service")
