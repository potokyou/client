...
void PageController::onShowErrorMessage(ErrorCode errorCode)
{
    ...
    const auto errorUrl = QStringLiteral("https://docs.potok.org/troubleshooting/error-codes/#error-%1-%2").arg(static_cast<int>(errorCode)).arg(utils::enumToString(errorCode).toLower());
